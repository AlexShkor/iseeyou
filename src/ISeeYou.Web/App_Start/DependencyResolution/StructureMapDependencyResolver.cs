...
namespace ISeeYou.Web.DependencyResolution
{
    /// <summary>
    /// The structure map dependency resolver.
    /// </summary>
    public class StructureMapDependencyResolver : Poker.Web.App_Start.DependencyResolution.StructureMapDependencyScope, IDependencyResolver
    {
